...
class PandaSim(object):
  ...
  def __init__(self, bullet_client):
    ...
    visGoalID = self.bullet_client.createVisualShape(self.bullet_client.GEOM_BOX, halfExtents=[0.1, 0.1, 2e-3],
                                                     rgbaColor=[1.0, 0.0, 0.0, 1.0])
  ...
  def add_box(self, halfExtents, rgbaColor, pos, baseMass=0.1):
    ...
    visBoxID = self.bullet_client.createVisualShape(self.bullet_client.GEOM_BOX,
                                                    halfExtents=halfExtents,
                                                    rgbaColor=rgbaColor)
    box = self.bullet_client.createMultiBody(baseMass=baseMass,
  ...
  def add_obstacle(self, halfExtents, rgbaColor, pos, baseMass=0.1):
    """
    Add one fixed box object in the simulation, as an obstacle.
    """
    self.obstacles.append(self.add_box(halfExtents, rgbaColor, pos, baseMass=baseMass))
